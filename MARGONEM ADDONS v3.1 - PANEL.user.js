...
(function() {
    ...
    let expowiska = {
        ...
        "Orki": {
            map: "Kwieciste Przejście, Złudny Trakt, Orcza Wyżyna, Grota Orczych Szamanów, Orcza Wyżyna, Osada Czerwonych Orków, Siedziba Rady Orków, Osada Czerwonych Orków, Orcza Wyżyna",
            mobs: "Szaman ziemi, Szaman wody, Szaman wiatru, Szaman żywiołu ognia, Orczy mistrz ostrzy, Ork waleczny młot, Ork szybkie cięcie, Łowca głów, Odważny ork, Mistrz halabardy",
            mobs_id: [],
            ignore_mob: []
        },
        "Molochy": {
            map: "Nithal, Winnica Meflakasti, Baszta Wilczych Kłów, Grota Heretyków p.2, Grota Heretyków p.1, Grota Heretyków p.2, Grota Heretyków p.3, Grota Heretyków p.4, Grota Heretyków p.5, Grota Heretyków p.4, Grota Heretyków p.3, Grota Heretyków p.2",
            mobs: "Moloch wojownik, Moloch czarnoksiężnik, Moloch, Moloch Klucznik, Jertek Moxos",
            mobs_id: [],
            ignore_mob: []
        },
        "Patrycjusze + draki": {
